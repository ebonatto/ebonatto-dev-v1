...
document.querySelector("#lang-checkbox").addEventListener("change", () => {
  if (apresIntro.innerText === "Olá, meu nome é") {
    ...
    cvLink.href = "./Resume_EBonatto_EN.pdf";
    linkedinLink.href =
      "https://www.linkedin.com/in/ebonattocosta/?locale=en_US";
  } else {
    ...
    cvLink.href = "./CV_EBonatto.pdf";
    linkedinLink.href = "https://www.linkedin.com/in/ebonattocosta/";
  }
});
